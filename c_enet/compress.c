...
typedef struct _ENetSymbol
{
    ...
    /** The number of times this symbol has occurred in the context. */
    enet_uint8 count;

    /** The aggregate count of the subtree rooted at this symbol in the binary indexed tree. */
    enet_uint16 under;

    /** The indices of the left and right children of this symbol in the symbol tree. */
    enet_uint16 left, right;

    /* context defined by this symbol */
    enet_uint16 symbols;

    /** The number of escape events recorded for this context. */
    enet_uint16 escapes;

    /** The total symbol count recorded for this context. */
    enet_uint16 total;

    /** The index of the parent symbol of this context. */
    enet_uint16 parent;
} ENetSymbol;
...
enum
{
    /** The top boundary of the range coder's probability interval. */
    ENET_RANGE_CODER_TOP = 1 << 24,

    /** The bottom boundary of the range coder's probability interval. */
    ENET_RANGE_CODER_BOTTOM = 1 << 16,

    /** The symbol count delta applied when a new symbol is added to a context. */
    ENET_CONTEXT_SYMBOL_DELTA = 3,

    /** The minimum number of symbols a context may hold. */
    ENET_CONTEXT_SYMBOL_MINIMUM = 1,

    /** The minimum escape count a context may hold. */
    ENET_CONTEXT_ESCAPE_MINIMUM = 1,

    /** The order of the subcontexts used for context modeling. */
    ENET_SUBCONTEXT_ORDER = 2,

    /** The symbol count delta applied when a new symbol is added to a subcontext. */
    ENET_SUBCONTEXT_SYMBOL_DELTA = 2,

    /** The escape count delta applied to a subcontext on an escape event. */
...
/** Rescales the symbol frequencies of a range coder model after they accumulate too much weight.
    @param symbol the symbol whose frequency is being rescaled.
*/
static enet_uint16
...
{
    /** The symbol value excluded from the context. */
    enet_uint8 value;

    /** The subtree count of the excluded symbol. */
    enet_uint16 under;
} ENetExclude;
